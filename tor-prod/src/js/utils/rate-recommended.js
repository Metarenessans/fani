export default function rateRecommended(present, future, payment, paymentper, payload, payloadper, periods, dayoffirstpayment = 0, dayoffirstpayload = 0, comission = 0, realdata = {}) {
