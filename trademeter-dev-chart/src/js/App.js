...
export default class App extends React.Component {
  ...
  updateChart(isInit = false) {
    ...
    const { days, mode, realData } = this.state;
    ...
    const factArray = [];
    factDays.forEach((value, index) => {
      factArray[value - 1] = data[value - 1].depoEnd;
    });
    const factData = factArray.map((value, index) => {
      return {
        x:     String(index + 1),
        value: value
      }
        ...
        <main className="main">
          ...
          <div className="container">
            ...
            {(() => {
              ...
              let lastFilledDay = Object.keys(realData).slice().pop();
              if (!lastFilledDay) {
                lastFilledDay = 0;
              }
                    ...
                    <Button
                      className={
                        []
                          ...
                          .concat(currentDay > lastFilledDay ? "section5__save--hidden" : "")
                          .concat("custom-btn")
                          .concat(
